        ...
        <div className="flex items-center justify-between h-[72px]">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <motion.div
              ...
              className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#f97316] to-[#fb923c] flex items-center justify-center text-[11px] font-black tracking-wider text-black shadow-[0_0_20px_rgba(249,115,22,0.35)]"
            >
              AI
            </motion.div>
            <span className="text-[15px] text-white/55 tracking-tight">
              Interview <strong className="text-white font-bold">Quasar</strong>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            {isAuthenticated ? (
              <>
                <Link
                  to="/"
                  className="flex items-center gap-2 rounded-full text-xs font-semibold tracking-wide text-white/60 border border-white/[0.08] hover:border-[#f97316]/50 hover:text-[#f97316] hover:bg-[#f97316]/[0.08] transition-all duration-200"
                ...
                <div className="flex items-center gap-2 ml-1">
                  <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#f97316] to-[#fb923c] flex items-center justify-center text-[11px] font-bold text-black">
